export function LocationSection() {
  return (
    <>
      ...
      <span className="font-label-sm text-label-sm font-bold text-ink-deep">De Metrô / BRT:</span>
      <span className="font-body-sm text-body-sm text-crimap-gray">Estação Jardim Oceânico com acesso por passarela integrada.</span>
      </div>
      <div className="flex flex-col gap-1">
      <span className="font-label-sm text-label-sm font-bold text-ink-deep">De Carro / Uber:</span>
      <span className="font-body-sm text-body-sm text-crimap-gray">Acesso direto pela Av. das Américas com Valet no Bloco 4.</span>
      </div>
      </div>
      </div>
      ...
      <div className="px-4 py-2.5 rounded-xl bg-surface-pure/95 backdrop-blur-md border border-soft-line flex items-center justify-between w-full shadow-sm">
      ...
      <a className="text-connection-blue font-label-sm font-semibold hover:underline flex items-center gap-1" href="https://maps.google.com/?q=Shopping+Downtown+Barra+da+Tijuca" rel="noopener noreferrer" target="_blank">
